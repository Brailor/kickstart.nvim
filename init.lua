...
require('nvim-treesitter.configs').setup {
  ...
  ensure_installed = { 'c', 'cpp', 'go','java', 'lua', 'python', 'rust', 'tsx', 'typescript', 'javascript', 'vimdoc', 'vim' },
...
function setup_java()
  ...
  local java_opts = {
    ...
    cmd = {
      ...
      -- .LOCAL/SHARE/NVIM/MASON/PACKAGES/JDTLS/FEATURES/ORG.ECLIPSE.EQUINOX.EXECUTABLE_3.8.2200.V20230717-2134.JAR
